...
@section('title', 'Recpciones | Editar')
...
<div class="row">
    <div class="col-md-12 mt-3 mb-3">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('receives.update') }}" method="POST">
                    @csrf
                    {{ method_field('PUT') }}
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="select-area-container">
                                    <select name="area_id" id="select-area" class="form-control">
                                        ...
                                        <option @selected(old('area', $received->area_id) == $area->id) value="{{ $area->id }}">{{ $area->nombre }}</option>
                                        @endforeach
                                    </select>
                                    @error('area_id')
                        ...
                        <div class="col-12 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="jefeinmediato" value="{{ old('jefeinmediato', $received->jefeinmediato) }}">
                                @error('jefeinmediato')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('receives.index') }}" class="btn btn-danger">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
